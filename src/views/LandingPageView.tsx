  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900 font-sans selection:bg-neutral-900 selection:text-white">
      {/* 
        ...
        Strict user constraint: "quitando todo el menú del top, solo tiene que tener el nombre de la app y la invitación a prueba gratis/crear cuenta/ingresar con la mejor técnica persuasiva"
      */}
      <header className="sticky top-0 bg-white/95 backdrop-blur-md z-40 border-b border-neutral-100 transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-18 flex items-center justify-between">
          ...
          {/* Persuasive Call To Action Group (No middle menu links) */}
          <div className="flex items-center gap-2.5 sm:gap-3">
            <button
              type="button"
              onClick={handleOpenLogin}
              className="text-xs font-semibold text-neutral-700 hover:text-neutral-950 px-3 py-2 rounded-xl hover:bg-neutral-50 transition cursor-pointer"
            >
              Ingresar
            </button>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              ...
              <div className="pt-1 flex flex-wrap items-center justify-center lg:justify-start gap-x-6 gap-y-2 text-xs text-neutral-500 font-medium">
                <span className="flex items-center gap-1.5">
                  <Check className="w-4 h-4 text-emerald-600 stroke-[3]" /> Sin tarjeta de crédito
                </span>
                <span className="flex items-center gap-1.5">
                  <Check className="w-4 h-4 text-emerald-600 stroke-[3]" /> Con tu mismo número de WhatsApp
                </span>
                <span className="flex items-center gap-1.5">
                  <Check className="w-4 h-4 text-emerald-600 stroke-[3]" /> 0% de comisiones por seña
                </span>
              </div>
            ...
            {/* 
              ...
              Constraint: "la vista del whatsapp de la landing ponla en modo movil que no ocupe toda la pantalla como ahora eso arruina la estética premium"
            */}
            <div className="lg:col-span-5 flex flex-col items-center justify-center">
              ...
              {/* REALISTIC MOBILE SMARTPHONE FRAME (iPhone Dimensions: ~310px wide) */}
                    ...
                    {activeScenario.messages.map((msg, idx) => {
                      if (msg.sender === 'system') {
                        return (
                          <div
                            key={idx}
                            className="bg-emerald-950/80 text-emerald-200 border border-emerald-800/60 p-2.5 rounded-xl text-[11px] leading-snug flex items-center gap-2 shadow-xs animate-fade-in"
                          >
                      ...
                      return (
                        <div
                          key={idx}
                          className={`flex flex-col ${isPatient ? 'items-start' : 'items-end'} animate-fade-in`}
                        >
                          <div
      ...
      {/* THREE SIMPLIFIED STEPS TO ONBOARD
        Constraint: "los pasos simplificados para crear la cuenta"
      */}
      <section className="py-20 px-4 sm:px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          {/* Step 1 */}
          <div className="p-7 rounded-3xl border border-neutral-200 bg-white shadow-2xs hover:shadow-md transition-all space-y-4 relative">
        ...
        <div className="mt-12 text-center">
          <button
            ...
            className="px-6 py-3.5 rounded-xl bg-neutral-950 hover:bg-neutral-800 text-white font-bold text-xs shadow-sm transition inline-flex items-center gap-2 cursor-pointer"
          >
      ...
      {/* COMPARISON TABLE: BEFORE VS WITH AGENDAPRO (Persuasive Punch) */}
      <section className="py-20 px-4 sm:px-6 bg-neutral-50 border-t border-b border-neutral-200/70">
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Without AgendaPro */}
            <div className="p-7 rounded-3xl bg-white border border-rose-200/80 shadow-xs space-y-4">
      ...
      <section className="py-20 px-4 sm:px-6 max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
          ...
          <p className="text-sm text-neutral-600">
            Diseñado específicamente para el ecosistema de salud y profesionales independientes en Argentina.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-6 rounded-3xl border border-neutral-200 bg-white hover:border-neutral-300 transition space-y-3 shadow-2xs">
            <div className="w-10 h-10 rounded-xl bg-neutral-950 text-white flex items-center justify-center">
              <MessageSquare className="w-5 h-5" />
            </div>
            <h3 className="text-base font-bold text-neutral-950">Bot de WhatsApp con Inteligencia Artificial</h3>
            <p className="text-xs text-neutral-600 leading-relaxed">
              Mantiene conversaciones fluidas, verifica tus huecos disponibles, responde dudas frecuentes de ubicación y atiende de noche sin que tengas que tocar el teléfono.
            </p>
          </div>
          ...
          <div className="p-6 rounded-3xl border border-neutral-200 bg-white hover:border-neutral-300 transition space-y-3 shadow-2xs">
            ...
            <h3 className="text-base font-bold text-neutral-950">Cobro de Señas con Alias & Mercado Pago</h3>
            <p className="text-xs text-neutral-600 leading-relaxed">
              El paciente transfiere el anticipo directamente a tu CBU, CVU o cuenta de Mercado Pago. Si no se acredita la seña en 15 minutos, el horario vuelve a quedar libre.
            </p>
          </div>
          ...
          <div className="p-6 rounded-3xl border border-neutral-200 bg-white hover:border-neutral-300 transition space-y-3 shadow-2xs">
            ...
            <h3 className="text-base font-bold text-neutral-950">Sincronización con Google Calendar</h3>
            <p className="text-xs text-neutral-600 leading-relaxed">
              Cada reserva confirmada se sincroniza instantáneamente con tu calendario personal. Puedes bloquear días de vacaciones o congresos en un solo clic.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 bg-neutral-50 border-t border-neutral-200/60">
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-3xl border border-neutral-200 bg-white shadow-xs space-y-4">
              <div className="flex items-center gap-1 text-amber-500">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-3.5 h-3.5 fill-amber-400 text-amber-400" />
                ))}
      ...
      <section className="py-20 px-4 sm:px-6 max-w-4xl mx-auto border-t border-neutral-200/60">
        ...
        <div className="space-y-3">
          {[
            ...
            },
            {
              ...
              a: 'Sí. Todos los turnos confirmados se sincronizan automáticamente con tu Google Calendar para que los veas en tu teléfono, computadora y smartwatch.'
            }
          ].map((item, idx) => (
            <div
              key={idx}
      ...
      <section className="py-20 px-4 sm:px-6 bg-neutral-950 text-white text-center relative overflow-hidden">
        <div className="max-w-3xl mx-auto space-y-6 relative z-10">
          ...
          <p className="text-xs sm:text-sm text-neutral-400 max-w-xl mx-auto leading-relaxed">
            Súmate a los más de 120 consultorios que ya operan con IA en Argentina. Sin contratos, sin tarjetas de crédito y con soporte personalizado.
          </p>
