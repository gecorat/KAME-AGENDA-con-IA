...
export const INITIAL_PRACTICE_SETTINGS: PracticeSettings = {
  ...
  whatsapp_session_phone: "+54 9 11 5000-0000",
  onboarding_completed_steps: ['profile', 'services', 'hours'],
  mercadopago_deposit_enabled: true,
  ...
  patient_deposit_method: 'alias_cbu',
  patient_deposit_alias: 'consultorio.turnos.mp',
  patient_deposit_cbu: '0000003100092837461524',
  patient_deposit_bank_name: 'Mercado Pago / Billetera Virtual',
  patient_deposit_account_holder: 'Consultorio Médico Integral',
  patient_deposit_cuit: '30-71829384-9',
  patient_deposit_mp_link: '',
  patient_deposit_mp_connected: false,
  evolution_api_url: 'https://api.evolution.dominio.com',
  evolution_api_key: '',
  evolution_instance_name: 'consultorio-principal',
  email_provider: 'resend',
  email_resend_api_key: '',
  email_sender_address: 'turnos@consultorio.com',
  email_sender_name: 'Consultorio Médico',
  email_reminders_active: true,
  // Public Page Customization Defaults
  public_profile_photo_url: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?w=400&auto=format&fit=crop&q=80',
  public_profile_photo_shape: 'rounded-smooth',
  public_profile_photo_align: 'left',
  public_theme_preset: 'minimal-slate',
  public_card_border_style: 'rounded-xl',
...
export const INITIAL_CONVERSATIONS: Conversation[] = [
  {
    ...
    messages: [
      ...
      },
      {
        id: "msg-4",
        role: "assistant",
        content: "¡Excelente! Ya te he agendado para hoy a las 15:00 hs en nuestro consultorio en Av. Santa Fe 3200, Piso 4 B.\n\nTe esperamos 10 minutos antes. Te llegará el recordatorio por este mismo medio.",
        timestamp: "10:41",
        actionTaken: {
...
export const INITIAL_CONSULTATIONS: ConsultationRecord[] = [
  {
    ...
    dental_tooth_number: "Sector 3.1 a 4.2",
    treatment_performed: "Destartraje ultrasónico completo y pulido coronario con pasta fluorada",
  ...
  },
  {
    ...
    consultation_type: "dental",
    dental_tooth_number: "Pieza 3.6 (Primer molar inferior izquierdo)",
    treatment_performed: "Apertura cameral de urgencia, pulpectomía bajo anestesia troncular con Articaína y sellado temporal con hidróxido de calcio",
    vital_signs_enabled: false,
    vital_signs: undefined,
...
export const DEMO_SAAS_TENANTS: SaasTenantUser[] = [
  {
    id: 'tenant-1',
    practice_name: 'Dermatología Avanzada Palermo',
    doctor_name: 'Dra. Camila Rossi',
    email: 'dra.camilarossi@gmail.com',
    phone: '+54 9 11 4455-8899',
    plan: 'pro',
    billing_cycle: 'monthly',
    status: 'active',
    subscription_started_at: '2026-03-12',
    next_billing_date: '2026-09-12',
    amount_monthly_ars: 34000,
    payment_method: 'mercadopago',
    last_payment_date: '2026-08-12',
    last_payment_amount: 34000,
    total_paid_ars: 204000,
    appointments_count: 312,
    whatsapp_status: 'connected'
  },
  {
    id: 'tenant-2',
    practice_name: 'Odontología Integral Belgrano',
    doctor_name: 'Dr. Martín Etcheverry',
    email: 'martin.etcheverry.odonto@gmail.com',
    phone: '+54 9 11 5566-1122',
    plan: 'pro',
    billing_cycle: 'monthly',
    status: 'active',
    subscription_started_at: '2026-04-18',
    next_billing_date: '2026-09-18',
    amount_monthly_ars: 34000,
    payment_method: 'mercadopago',
    last_payment_date: '2026-08-18',
    last_payment_amount: 34000,
    total_paid_ars: 170000,
    appointments_count: 485,
    whatsapp_status: 'connected'
  },
  {
    id: 'tenant-3',
    practice_name: 'Espacio Terapéutico Recoleta',
    doctor_name: 'Lic. Sofía Peralta',
    email: 'lic.sofiaperalta@gmail.com',
    phone: '+54 9 11 6677-3344',
    plan: 'basic',
    billing_cycle: 'monthly',
    status: 'active',
    subscription_started_at: '2026-05-21',
    next_billing_date: '2026-09-21',
    amount_monthly_ars: 19000,
    payment_method: 'mercadopago',
    last_payment_date: '2026-08-21',
    last_payment_amount: 19000,
    total_paid_ars: 76000,
    appointments_count: 142,
    whatsapp_status: 'disconnected'
  },
  {
    id: 'tenant-4',
    practice_name: 'Traumatología & Deporte Norte',
    doctor_name: 'Dr. Federico Almada',
    email: 'dr.almada.trauma@gmail.com',
    phone: '+54 9 11 7788-5566',
    plan: 'pro',
    billing_cycle: 'monthly',
    status: 'active',
    subscription_started_at: '2026-02-25',
    next_billing_date: '2026-09-25',
    amount_monthly_ars: 34000,
    payment_method: 'mercadopago',
    last_payment_date: '2026-08-25',
    last_payment_amount: 34000,
    total_paid_ars: 238000,
    appointments_count: 520,
    whatsapp_status: 'connected'
  },
  {
    id: 'tenant-5',
    practice_name: 'Cardiología Preventiva San Isidro',
    doctor_name: 'Dr. Nicolás Varela',
    email: 'nicolas.varela.cardio@gmail.com',
    phone: '+54 9 11 3344-7788',
    plan: 'pro',
    billing_cycle: 'monthly',
    status: 'active',
    subscription_started_at: '2026-06-08',
    next_billing_date: '2026-09-08',
    amount_monthly_ars: 34000,
    payment_method: 'mercadopago',
    last_payment_date: '2026-08-08',
    last_payment_amount: 34000,
    total_paid_ars: 102000,
    appointments_count: 230,
    whatsapp_status: 'connected'
  },
  {
    id: 'tenant-6',
    practice_name: 'Pediatría San Jerónimo',
    doctor_name: 'Dra. Valeria Gómez',
    email: 'valeriagomez.pediatra@gmail.com',
    phone: '+54 9 11 8899-2233',
    plan: 'basic',
    billing_cycle: 'monthly',
    status: 'active',
    subscription_started_at: '2026-06-29',
    next_billing_date: '2026-09-29',
    amount_monthly_ars: 19000,
    payment_method: 'mercadopago',
    last_payment_date: '2026-08-29',
    last_payment_amount: 19000,
    total_paid_ars: 57000,
    appointments_count: 189,
    whatsapp_status: 'disconnected'
  },
  {
    id: 'tenant-7',
    ...
    status: 'active',
    subscription_started_at: '2026-04-03',
    next_billing_date: '2026-10-03',
    amount_monthly_ars: 27200, // Equiv anual prorrateado
    payment_method: 'transfer',
    last_payment_date: '2026-04-03',
    last_payment_amount: 326400,
    total_paid_ars: 326400,
    appointments_count: 380,
    whatsapp_status: 'connected'
  },
  {
    id: 'tenant-8',
    practice_name: 'Nutrición & Metabolismo',
    doctor_name: 'Lic. Marcela Domínguez',
    email: 'mdominguez.nutri@gmail.com',
    phone: '+54 9 11 2233-6677',
    plan: 'basic',
    billing_cycle: 'monthly',
    status: 'active',
    subscription_started_at: '2026-07-15',
    next_billing_date: '2026-09-15',
    amount_monthly_ars: 19000,
    payment_method: 'mercadopago',
    last_payment_date: '2026-08-15',
    last_payment_amount: 19000,
    total_paid_ars: 38000,
  ...
  },
  {
    ...
    next_billing_date: '2026-09-15',
    amount_monthly_ars: 34000, // Prospecto Pro
    payment_method: 'mercadopago',
    last_payment_date: '-',
  ...
  {
    id: 'tenant-10',
    practice_name: 'Oftalmología Láser Quilmes',
    doctor_name: 'Dr. Julián Castro',
    email: 'juliancastro.oftalmo@gmail.com',
    phone: '+54 9 11 5544-9922',
    plan: 'trial',
    billing_cycle: 'monthly',
    status: 'trial',
    subscription_started_at: '2026-09-02',
